    ...
    return (
        <div>
            ...
            <div className="w-full mt-[150px] flex flex-col justify-end items-end">
                <div className="items-center w-full" style={{ backgroundColor: 'yellow' }}>
                ...
                <div
                    ...
                    style={{ alignItems: "start", height: '58%', justifyContent: 'center', display: 'flex' }}
                >
            ...
            <div className='lg:px-[120px] md:px-[60px] px-[30px] flex md:flex-row flex-col items-center bg-[#FFF8F6]' style={{ width: "65%", padding: "0 0 0 8rem", }}>
                <div className='bg-[#FFF8F6] md:w-1/2 w-full h-[50%] md:pe-[80px] flex flex-col justify-center' style={{ paddingTop: 30, paddingBottom: 30 }}>
                    <span className='text-[45px] font-semibold md:text-start text-center'>TAKE CONTROL OF <br />YOUR HEALTH</span>
                    <div className='mt-[17px] '>
                        <p className='text-[15px] md:text-start text-center text-[#454545] font-medium'>The Good4Me range has been formulated based on scientific & <br />traditional evidence.</p>
                        <p className='text-[15px] md:text-start text-center text-[#454545] font-medium my-[12px]'>Our vitamins are here and ready to boost your mood, immunity and <br />overall well-being!</p>
                        <p className='text-[15px] md:text-start text-center text-[#454545] font-medium'>Made in New Zealand from local and imported ingredients.</p>
                    </div>
                    <div className='mt-[34px] flex md:justify-start justify-center'>
                        <a href="#" className='py-[13px] px-[45px] border-[2px] border-[#F6623E] text-[16px] font-medium'>BROWSE OUR RANGE</a>
                    </div>
                </div>

                <div className='flex sm:flex-row flex-col items-center h-full md:w-1/2 w-full md:mt-0 mt-[35px]' style={{ display: "flex", justifyContent: "end" }}>
            ...
            <div className='lg:px-[120px] md:px-[60px] px-[30px] mt-[135px] flex flex-col items-center'>
                ...
                <div>
                    <a href="#" className='border-[2px] border-[#F6623E] px-[45px] py-[15px] text-[16px] font-medium'>VIEW ALL PRODUCTS</a>
                </div>
            </div>
            {/* Our Products Are */}
            ...
            <div className='w-full bg-[#FEF0E7] my-[85px]'>
                ...
                <div className='pt-[70px] lg:px-[200px] md:px-[60px] px-[30px]  pb-[45px] flex md:flex-row flex-col-reverse justify-between'>
                    <div className='md:w-3/5 w-full flex flex-col md:mt-0 mt-[30px] justify-between md:items-start items-center'>
                        ...
                        <p className='text-[26px] tracking-[1px] font-medium md:text-start text-center my-[5px]'>“We have perfected our formulas over time,<br /> based on your feedback. Check out hundreds of <br />reviews on our website.We can't wait until you <br />are a part of our Good4Me Family.”</p>
            ...
            <div className='lg:px-[120px] md:px-[60px] px-[30px] flex flex-col items-center'>
                ...
                <div>
                    <a href="#" className='px-[45px] py-[15px] border-[2px] border-[#F6623E] text-[16px] font-medium'>VIEW ALL PRODUCTS</a>
                </div>
            </div>
            {/* Shop All */}
            ...
            <div className='lg:w-[65%] w-[90%] mx-auto my-[115px]'>
                <div className='flex justify-center'>
                    <span className='text-[36px] font-medium' style={{ paddingBottom: "13px" }}>LATEST NEWS</span>
                </div>
